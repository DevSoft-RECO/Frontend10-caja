...
const menuItems = computed(() => {
    ...
    const items = [
        ...
        },
        {
            ...
            show: authStore.hasPermission('cajeros'),
            children: [
        ...
        {
            id: 'reportar-inconvenientes',
            label: 'Reportar Inconvenientes',
            ...
            show: computed(() => {
                return authStore.hasPermission('reversion_caja') || authStore.hasPermission('reporte_descuadres')
            }).value,
            children: [
        ...
        },
        {
            ...
            show: authStore.hasPermission('autorizaciones'),
            children: [
        ...
        {
            id: 'configuracion-denominaciones',
            label: 'Configuración Denominaciones',
            ...
            show: authStore.hasPermission('denominaciones') || authStore.hasRole('Super Admin'),
            children: [
        ...
        },
        {
            ...
            show: authStore.hasPermission('configuracion_caja'),
            children: [
